			...
			<form>
				<table class="table table-bordered .table-responsive text-center">
					...
					<tr>
						...
						<td><a href="{{asset('frontend/cart/delete/'.$item->rowId)}}">Xóa</a></td>
					</tr>
					@endforeach
				</table>
				<div class="row" id="total-price">
					...
					<div class="col-md-6 col-sm-12 col-xs-12">
						<a href="{{asset('frontend/home')}}" class="my-btn btn">Mua tiếp</a>
						<a href="#" class="my-btn btn">Cập nhật</a>
						<a href="{{asset('frontend/cart/delete/all')}}" class="my-btn btn">Xóa giỏ hàng</a>
					</div>
				</div>
			</form>             	                	
		</div>
